...
// posts at build time and lists them. The calculator lives at /calculator; a
// prominent button in the top bar sends readers straight to it.

export const metadata: Metadata = {
  title: "Close the Distance — the long-distance Journal & calculator",
  description:
  ...
  openGraph: {
    ...
    description:
      "Honest notes on the money and logistics of closing the distance in a long-distance relationship — with a free calculator.",
    type: "website",
  },
};
        ...
        <div className="flex flex-col items-start gap-5 sm:flex-row sm:gap-6">
          ...
          <div>
            ...
            <p className="mt-3.5 max-w-[560px] text-[16px] leading-relaxed text-[#6b6068] sm:text-[18px]">
              ...
              finally living together — and a free calculator to run your own numbers.
            </p>
            <Link
              href="/calculator"
              className="mt-5 inline-block rounded-xl bg-[#b25c72] px-5 py-3 text-[14px] font-semibold text-white transition hover:brightness-105"
            >
              Can you afford to move in together? →
            </Link>
          </div>
        </div>
